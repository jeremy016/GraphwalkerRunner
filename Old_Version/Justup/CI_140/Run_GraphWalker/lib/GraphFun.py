# -*- coding: utf-8 -*- 
import json,os,time,sys,shlex, subprocess,requests
...
class GraphFun(object):
    ...
    def Count_Walked(self, stop_condition):
        ...
        Walked_list = []
        path_result = os.popen("java -jar ./lib/graphwalker-cli-3.4.0-SNAPSHOT.jar offline --json -m merged_mark.graphml \""+stop_condition+"\"").read()
    ...
    def Run_Websocket(self,blocked_exist):
        ...
        pid = os.popen('java -jar ./lib/graphwalker-cli-3.4.0-SNAPSHOT.jar online --json --service RESTFUL -m merged_mark.graphml \"random(edge_coverage(100))\" &')
    ...
    def Connection_Aborted(self,e):
        ...
        command_line = "java -jar ./lib/graphwalker-cli-3.4.0-SNAPSHOT.jar online --json --service RESTFUL -m merged_mark.graphml \"random(edge_coverage(100))\""
    ...
    def CheckGraphicalIntegrity(self):
        ...
        os.popen('java -jar ./lib/graphwalker-cli-3.4.0-SNAPSHOT.jar online --json --service RESTFUL -m merged_mark.graphml \"random(edge_coverage(100))\" &') 
        time.sleep(5)
        ...
        os.popen('rm script_test.py script_test.pyc')
    ...
    def Generate_XML(self, complete_value, error_list, pass_dic, BLOCKED):
        ...
        #Conditional Pass
            ...
            for i in error_list:
                ...
                img = 'http://192.168.20.140:8080/jenkins/job/MBT_Project/job/JUSTUP/ws/Graphwalker/Justup/for_140/Run_GraphWalker/Screenshot/'+str(i['Fail_Fun'])+'.png'
